...
% fakta item
market_item(1, carrot, 'Carrot', 50).
market_item(2, corn_seed, 'Corn', 50).
market_item(3, tomato_seed, 'Tomato', 50).
market_item(4, potato, 'Potato', 50).
market_item(5, chicken, 'Chicken', 500).
market_item(6, sheep, 'Sheep', 1000).
market_item(7, cow, 'Cow', 1500).
market_item(8, shovel2, 'Lvl 2 Shovel', 300).
market_item(9, fishing_rod2, 'Lvl 2 Fishing Rod', 500).
...
buyItem(FinalPrice, Item, Quantity):-
    ...
    assertz(item_in_inventory(Item, 1, Quantity)).

buyItem(FinalPrice, _, _):-
    gold(Gold), FinalPrice > Gold,
